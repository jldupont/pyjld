#!/usr/bin/env python
"""
pyjld.phidgets.bonjour
"""
__author__  = "Jean-Lou Dupont"
__email     = "python (at) jldupont.com"
__fileid    = "$Id: msgs.py 69 2009-04-17 18:49:17Z jeanlou.dupont $"
...
#
'error_creating_phidgets_discovered_folder':    'Cannot create phidget discovered folder [$path]',
'info_created_phidgets_discovered_folder':      'Created phidget discovered folder [$path]',
...
# Dbus
'error_dbus_sessionbus_creation':           'Cannot create a Dbus session bus',
'':'',
'':'',
}
